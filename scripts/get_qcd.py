...
command = ("law run FeaturePlotQCDTest --feature-names {}    --version qcd_test" + options.version + "__{}   --category-name {}    --region-name {}_os_iso --SkimCategorization-version prod{} "
    ...
    "--data-config-names {} "
    "--event-weights False --FeaturePlot-qcd-category-name {} --skip-dataset-names {}")
...
# params[2016]["boosted"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "boosted_nomcut")
params[2016]["boosted"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "boosted")
#params[2016]["boosted"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "boosted_nobtag")
# params[2016]["boosted"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "default")
# params[2016]["boosted_nobtag"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "default")
# params[2016]["boosted_nomcut"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "default")
params[2016]["resolved_1b"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "default") 
params[2016]["resolved_2b"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "default") 

params[2017] = OrderedDict()
# params[2017]["boosted"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "boosted_nomcut")
params[2017]["boosted"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "boosted")
#params[2017]["boosted"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "boosted_nobtag")
# params[2017]["boosted"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "default")
# params[2017]["boosted_nobtag"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "default")
# params[2017]["boosted_nomcut"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "default")
params[2017]["resolved_1b"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "default") 
params[2017]["resolved_2b"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "default") 

params[2018] = OrderedDict()
# params[2018]["boosted"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "boosted_nomcut")
params[2018]["boosted"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "boosted")
#params[2018]["boosted"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "boosted_nobtag")
# params[2018]["boosted"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "default")
# params[2018]["boosted_nobtag"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "default")
# params[2018]["boosted_nomcut"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "default")
params[2018]["resolved_1b"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "default") 
params[2018]["resolved_2b"] = (["Feb", "Feb", "FebETau"], ["lep1_eta"], "default") 
...
for year in params:
    ...
    for category in params[year]:
        ...
        stuff[year][my_category] = OrderedDict()
        for channel in ["tautau", "mutau", "etau"]:
            ...
            stuff[year][my_category][channel] = OrderedDict()
            for features in params[year][category][1]:
                for feature in features.split(","):
                    stuff[year][my_category][channel][feature] = OrderedDict()
ss_iso = OrderedDict() 
                    ...
                    for feature in features.split(","):
                        ...
                        with open(name) as f:
                            ...
                            for l in lines:
                                ...
                                # print name, values
                                stuff[year][my_category][channel][feature][values[0]] = (values[1],
                                    values[2])
            ...
            for features in params[year][category][1]:
                for feature in features.split(","):
                    ...
                    for i, channel in enumerate(["tautau", "mutau", "etau"]):
                        ...
                        this_st = stuff[year][my_category][channel][feature]
        ...
        # for category in ss_iso[year]:
            # for feature in params[year][category][1].split(","):
                # for i, channel in enumerate(["tautau", "mutau", "etau"]):
                    ...
                    # my_str = (
                        # "0" if stuff[year][category][channel]["Standard"] == 0
                    ...
                    for year in ss_inviso:
                        ...
                        if my_category not in ss_inviso[year].keys():
                            ...
                            # else:
                                # lnN = -1
                            my_str += (
                                "& {:<5} ".format("$-$") if float(stuff[year][my_category][channel][feature]["Standard"][0]) == 0
                ...
                for i, channel in enumerate(["tautau", "mutau", "etau"]):
                    ...
                    for year in ss_inviso:
                        ...
                        if my_category not in ss_inviso[year].keys():
                            ...
                            my_str += (
                                "& {:<12} ".format("$-$") if float(stuff[year][my_category][channel][feature]["Standard"][0]) == 0
            ...
            # for year in ss_inviso:
                ...
                # else:
                    # if (not is_compatible(ss_iso[year][category][channel]) and not is_compatible(os_inviso[year][category][channel])
                        ...
                        # value, error = redondear(value, error)
                    # my_str += (
                        # "& {:^5} ".format("$-$") if stuff[year][category][channel]["Standard"][0] == 0
                    ...
                    for i, channel in enumerate(["tautau", "mutau", "etau"]):
                        ...
                        for year in ss_inviso:
                            ...
                            if my_category not in ss_inviso[year].keys():
                                ...
                                my_str += (
                                    "& {:<20} ".format("$-$") if float(stuff[year][my_category][channel][feature]["Standard"][0]) == 0
