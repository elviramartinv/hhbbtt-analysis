...
class Config(cmt_config):
    ...
    def add_regions(self):
        ...
        # selection["os_inviso__100_200"] = {
        #     "mutau": ["isOS == 1", "dau1_iso < 0.15", "dau2_deepTauVsJet >= 1",
        #         "dau2_deepTauVsJet < %s" % self.deeptau.vsjet.Medium,
        #         "HH_mass >= 100", "HH_mass < 200"],
        #     "etau": ["isOS == 1", "dau1_eleMVAiso == 1", "dau2_deepTauVsJet >= 1",
        #         "dau2_deepTauVsJet < %s" % self.deeptau.vsjet.Medium,
        #         "HH_mass >= 100", "HH_mass < 200"],
        #     "tautau": ["isOS == 1",
        ...
        #         "HH_mass >= 100", "HH_mass < 200"],
        # }
        # selection["os_inviso__200_300"] = {
        #     "mutau": ["isOS == 1", "dau1_iso < 0.15", "dau2_deepTauVsJet >= 1",
        #         "dau2_deepTauVsJet < %s" % self.deeptau.vsjet.Medium,
        #         "HH_mass >= 200", "HH_mass < 300"],
        #     "etau": ["isOS == 1", "dau1_eleMVAiso == 1", "dau2_deepTauVsJet >= 1",
        #         "dau2_deepTauVsJet < %s" % self.deeptau.vsjet.Medium,
        #         "HH_mass >= 200", "HH_mass < 300"],
        #     "tautau": ["isOS == 1",
        ...
        #         "HH_mass >= 200", "HH_mass < 300"],
        # }
        # selection["os_inviso__300_400"] = {
        #     "mutau": ["isOS == 1", "dau1_iso < 0.15", "dau2_deepTauVsJet >= 1",
        #         "dau2_deepTauVsJet < %s" % self.deeptau.vsjet.Medium,
        #         "HH_mass >= 300", "HH_mass < 400"],
        #     "etau": ["isOS == 1", "dau1_eleMVAiso == 1", "dau2_deepTauVsJet >= 1",
        #         "dau2_deepTauVsJet < %s" % self.deeptau.vsjet.Medium,
        #         "HH_mass >= 300", "HH_mass < 400"],
        #     "tautau": ["isOS == 1",
        ...
        #         "HH_mass >= 300", "HH_mass < 400"],
        # }
        # selection["os_inviso__400_500"] = {
        #     "mutau": ["isOS == 1", "dau1_iso < 0.15", "dau2_deepTauVsJet >= 1",
        #         "dau2_deepTauVsJet < %s" % self.deeptau.vsjet.Medium,
        #         "HH_mass >= 400", "HH_mass < 500"],
        #     "etau": ["isOS == 1", "dau1_eleMVAiso == 1", "dau2_deepTauVsJet >= 1",
        #         "dau2_deepTauVsJet < %s" % self.deeptau.vsjet.Medium,
        #         "HH_mass >= 400", "HH_mass < 500"],
        #     "tautau": ["isOS == 1",
        ...
        #         "HH_mass >= 400", "HH_mass < 500"],
        # }
        # selection["os_inviso__500_750"] = {
        #     "mutau": ["isOS == 1", "dau1_iso < 0.15", "dau2_deepTauVsJet >= 1",
        #         "dau2_deepTauVsJet < %s" % self.deeptau.vsjet.Medium,
        #         "HH_mass >= 500", "HH_mass < 750"],
        #     "etau": ["isOS == 1", "dau1_eleMVAiso == 1", "dau2_deepTauVsJet >= 1",
        #         "dau2_deepTauVsJet < %s" % self.deeptau.vsjet.Medium,
        #         "HH_mass >= 500", "HH_mass < 750"],
        #     "tautau": ["isOS == 1",
        ...
        #         "HH_mass >= 500", "HH_mass < 750"],
        # }
        # selection["os_inviso__750_1000"] = {
        #     "mutau": ["isOS == 1", "dau1_iso < 0.15", "dau2_deepTauVsJet >= 1",
        #         "dau2_deepTauVsJet < %s" % self.deeptau.vsjet.Medium,
        #         "HH_mass >= 750", "HH_mass < 1000"],
        #     "etau": ["isOS == 1", "dau1_eleMVAiso == 1", "dau2_deepTauVsJet >= 1",
        #         "dau2_deepTauVsJet < %s" % self.deeptau.vsjet.Medium,
        #         "HH_mass >= 750", "HH_mass < 1000"],
        #     "tautau": ["isOS == 1",
        ...
        #         "HH_mass >= 750", "HH_mass < 1000"],
        # }
        # selection["os_inviso__1000_1500"] = {
        #     "mutau": ["isOS == 1", "dau1_iso < 0.15", "dau2_deepTauVsJet >= 1",
        #         "dau2_deepTauVsJet < %s" % self.deeptau.vsjet.Medium,
        #         "HH_mass >= 1000", "HH_mass < 1500"],
        #     "etau": ["isOS == 1", "dau1_eleMVAiso == 1", "dau2_deepTauVsJet >= 1",
        #         "dau2_deepTauVsJet < %s" % self.deeptau.vsjet.Medium,
        #         "HH_mass >= 1000", "HH_mass < 1500"],
        #     "tautau": ["isOS == 1",
        ...
        #         "HH_mass >= 750", "HH_mass < 1000"],
        # }
        # selection["ss_inviso__1000_1500"] = {
        #     "mutau": ["isOS == 0", "dau1_iso < 0.15", "dau2_deepTauVsJet >= 1",
        #         "dau2_deepTauVsJet < %s" % self.deeptau.vsjet.Medium,
        #         "HH_mass >= 1000", "HH_mass < 1500"],
        #     "etau": ["isOS == 0", "dau1_eleMVAiso == 1", "dau2_deepTauVsJet >= 1",
    ...
    def add_features(self):
        features = [
            # bjet features
            Feature("bjet1_pt", "bjet1_pt", binning=(30, 20, 200),
                x_title=Label("b_{1} p_{T}"),
                units="GeV"),
            Feature("bjet1_pt_unsmeared", "bjet1_pt / bjet1_smearFactor", binning=(20, 20, 220),
                x_title=Label("b_{1} p_{T}"),
                units="GeV"),
            Feature("bjet1_eta", "bjet1_eta", binning=(25, -2.5, 2.5),
                x_title=Label("b_{1} #eta")),
            Feature("bjet1_phi", "bjet1_phi", binning=(25, -3.14159, 3.14159),
            ...
            Feature("bjet1_e_unsmeared", "bjet1_e / bjet1_smearFactor", binning=(58, 10, 590),
                x_title=Label("b_{1} energy"),
                units="GeV"),
            Feature("bjet2_pt", "bjet2_pt", binning=(30, 20, 200),
                x_title=Label("b_{2} p_{T}"),
                units="GeV"),
            Feature("bjet2_eta", "bjet2_eta", binning=(25, -2.5, 2.5),
                x_title=Label("b_{2} #eta")),
            Feature("bjet2_phi", "bjet2_phi", binning=(25, -3.14159, 3.14159),
            ...
            # Deepflavour
            Feature("bjet1_deepFlav", "bjet1_bID_deepFlavor", binning=(40, 0, 1),
                x_title=Label("b_{1} deepFlavor bID")),
            Feature("bjet2_deepFlav", "bjet2_bID_deepFlavor", binning=(40, 0, 1),
            ...
            Feature("lep1_pt", "dau1_pt", binning=(20, 0, 200),
                ...
                units="GeV"),
            Feature("lep1_eta", "dau1_eta", binning=(25, -2.5, 2.5),
                x_title=Label("#tau_{1} #eta")),
            Feature("lep1_phi", "dau1_phi", binning=(25, -3.14159, 3.14159),
            ...
            Feature("lep2_pt", "dau2_pt", binning=(20, 0, 200),
                ...
                systematics=["muon", "electron_dm0", "electron_dm1",
                            "tau_dm0", "tau_dm1", "tau_dm10", "tau_dm11"],
                units="GeV"),
            Feature("lep2_eta", "dau2_eta", binning=(25, -2.5, 2.5),
                x_title=Label("#tau_{2} #eta")),
            Feature("lep2_phi", "dau2_phi", binning=(25, -3.14159, 3.14159),
            ...
            # DeepTau 
            Feature("lep1_deepTauVSMu", "dau1_deepTauVsMu", binning=(10, -0.5, 9.5),
                    x_title=Label("#tau_{1} deepTau vs mu")),
            Feature("lep1_deepTauVSe", "dau1_deepTauVsEle", binning=(10, -0.5, 9.5),
                    x_title=Label("#tau_{1} deepTau vs ele")),
            Feature("lep1_deepTauVSjet", "dau1_deepTauVsJet", binning=(10, -0.5, 9.5),
                    x_title=Label("#tau_{1} deepTau vs jet")),
            Feature("lep2_deepTauVSmu", "dau2_deepTauVsMu", binning=(10, -0.5, 9.5),
                    x_title=Label("#tau_{2} deepTau vs mu")),
            Feature("lep2_deepTauVSe", "dau2_deepTauVsEle", binning=(10, -0.5, 9.5),
                    x_title=Label("#tau_{2} deepTau vs ele")),
            Feature("lep2_deepTauVSjet", "dau2_deepTauVsJet", binning=(10, -0.5, 9.5),
                    x_title=Label("#tau_{2} deepTau vs jet")),


            # MET
            Feature("met_pt", "met_et", binning=(40, 0, 350),
                x_title=Label("MET p_t"),
                units="GeV"),
            Feature("met_phi", "met_phi", binning=(25, -3.2, 3.2),
                x_title=Label("MET #phi")),

            # Hbb
            Feature("Hbb_pt", "bH_pt", binning=(30, 0, 600),
            ...
            # Htt
            Feature("Htt_pt", "tauH_pt", binning=(30, 0, 400),
            ...
            # Htt (SVFit)
            Feature("Htt_svfit_pt", "tauH_SVFIT_pt", binning=(30, 0, 400),
            ...
            # HH
            Feature("HH_pt", "HH_pt", binning=(30, 0, 300),
            ...
            Feature("HH_mass", "HH_mass", binning=(50, 0, 3000),
                x_title=Label("HH m"),
                units="GeV"),
