...
class Config(base_config):
    def __init__(self, *args, **kwargs):
        ...
        self.btag=DotDict(tight=0.7264, medium=0.2489, loose=0.0480) # DeepJet WP from KLUB framework https://github.com/LLRCMS/KLUBAnalysis/blob/master/config/selectionCfg_MuTau_UL16.cfg 
        self.pnet=DotDict(tight=0.9883, medium=0.9735, loose=0.9137) # PNet WP from KLUB framework
    ...
    def add_datasets(self):
        skim_directory = "/eos/user/l/lportale/hhbbtautau/skims/SKIMS_UL16"
...
config = Config("qcd_llr_2016", year=2016, ecm=13, lumi_pb=16800)