...
class Config(base_config):
    def __init__(self, *args, **kwargs):
        ...
        self.btag=DotDict(tight=0.7264, medium=0.3040, loose=0.0532) # DeepJet WP from KLUB framework https://github.com/LLRCMS/KLUBAnalysis/blob/master/config/selectionCfg_MuTau_UL17.cfg 
        self.pnet=DotDict(tight=0.987, medium=0.9714, loose=0.9105) # PNet WP from KLUB framework
...
config = Config("qcd_llr_2017", year=2017, ecm=13, lumi_pb=41529)