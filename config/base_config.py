    ...
    def add_processes(self):
        processes = [
            ...
            Process("vbf_1_2_1", Label("HH_{VBF}^{(1,2,1)}"),
                color=( 150, 74, 139 ), isSignal=True, parent_process="vbf"),

            Process("dy", Label("DY"), color=( 150, 74, 139 ), isDY=True, llr_name="DY"),
            Process("dy_high", Label("DY"), color=( 150, 74, 139 ), isDY=True, parent_process="dy"),
            Process("dy_low", Label("DY"), color=( 150, 74, 139 ), isDY=True, parent_process="dy"),
            Process("dy_0j", Label("DY"), color=( 150, 74, 139 ), isDY=True, parent_process="dy"),
            Process("dy_1j", Label("DY"), color=( 150, 74, 139 ), isDY=True, parent_process="dy"),
            Process("dy_2j", Label("DY"), color=( 150, 74, 139 ), isDY=True, parent_process="dy"),
            Process("dy_PtZ_0To50", Label("DY"), color=( 150, 74, 139 ), isDY=True, parent_process="dy"),
            Process("dy_PtZ_50To100", Label("DY"), color=( 150, 74, 139 ), isDY=True, parent_process="dy"),
            Process("dy_PtZ_100To250", Label("DY"), color=( 150, 74, 139 ), isDY=True, parent_process="dy"),
            Process("dy_PtZ_250To400", Label("DY"), color=( 150, 74, 139 ), isDY=True, parent_process="dy"),
            Process("dy_PtZ_400To650", Label("DY"), color=( 150, 74, 139 ), isDY=True, parent_process="dy"),
            Process("dy_PtZ_650ToInf", Label("DY"), color=( 150, 74, 139 ), isDY=True, parent_process="dy"),

            Process("tt", Label("t#bar{t}"), color=(156, 156, 161), llr_name="TT"),
            ...
            Process("others", Label("Others"), color=( 228, 37, 54 )),

            Process("ttH", Label("t#bar{t}H"), color=(218, 65, 134), 
                llr_name="ttH"),
            ...
            Process("w+jets", Label("W + jets"), color=( 248, 156, 32), llr_name="WJets"),
            Process("wjets", Label("W + jets"), color=( 248, 156, 32), parent_process="w+jets",
                llr_name="WJets"),

            Process("TW", Label("TW"), color=(65, 218, 201)),
            Process("tw", Label("t + W"), color=( 228, 37, 54 ), parent_process="others",
                llr_name="TW"),
            Process("singleT", Label("singleT"), color=(65, 120, 218)),
            Process("singlet", Label("Single t"), color=( 228, 37, 54 ), parent_process="others",
                llr_name="singleT"),
            Process("EWK", Label("EWK"), color=(27, 106, 46)),
            Process("ewk", Label("EWK"), color=( 228, 37, 54 ), parent_process="others"),
            Process("ZH", Label("ZH"), color=(27, 83, 106)),
            Process("zh", Label("ZH"), color=( 228, 37, 54 ), parent_process="others"),
            Process("WH", Label("WH"), color=(85, 92, 166)),
            Process("wh", Label("WH"), color=( 228, 37, 54 ), parent_process="others"),
            Process("TTX", Label("TTX"), color=(85, 166, 96)),
            Process("ttx", Label("ttX"), color=( 228, 37, 54 ), parent_process="others"),
            Process("TTHX", Label("TTHX"), color=(89, 24, 184)),
            Process("ttxh", Label("ttXH"), color=(228, 37, 54), parent_process="others"),
            Process("ggH", Label("ggH"), color=(215, 35, 21)),
            Process("ggh", Label("ggH"), color=( 228, 37, 54 ), parent_process="others"),
            Process("qqH", Label("qqH"), color=(131, 34, 26)),
            Process("vbfh", Label("VBFH"), color=( 228, 37, 54 ), parent_process="others"),
            Process("VV", Label("VV"), color=(220, 220, 48)),
            Process("vv", Label("VV"), color=( 228, 37, 54 ), parent_process="others"),
            # Process("WW", Label("WW"), color=(220, 220, 48)),
            # Process("ww", Label("WW"), color= (220,220,48), parent_process="WW"),
            # Process("WZ", Label("WZ"), color=(184, 167, 24)),
            # Process("wz", Label("WZ"), color=(184,167,24), parent_process="WZ"),
            # Process("ZZ", Label("ZZ"), color=(65, 218, 201)),
            # Process("zz", Label("ZZ"), color=(65,218,201), parent_process="ZZ"),
            Process("VVV", Label("VVV"), color=(184, 167, 24)),
            Process("vvv", Label("VVV"), color=( 228, 37, 54 ), parent_process="others"),
