...
class Config(base_config):
    def __init__(self, *args, **kwargs):
        ...
        self.btag=DotDict(tight=0.7264, medium=0.2598, loose=0.0508) # DeepJet WP from KLUB framework https://github.com/LLRCMS/KLUBAnalysis/blob/master/config/selectionCfg_MuTau_UL16APV.cfg 
        self.pnet=DotDict(tight=0.9883, medium=0.9737, loose=0.9088) # PNet WP from KLUB framework
    ...
    def add_datasets(self):
        skim_directory = "/eos/user/l/lportale/hhbbtautau/skims/SKIMS_UL16APV"
...
config = Config("qcd_llr_2016APV", year=2016, ecm=13, lumi_pb=19500)