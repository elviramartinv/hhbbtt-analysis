...
class Config(cmt_config):
    ...
    def add_categories(self):
        ...
        categories = [
            ...
            # Category("SR", label="SR category", selection=sel["os_iso"]),
        ]
    ...
    def add_features(self):
        features = [
            ...
            # DeepTau
            Feature("DeepTauv2p1VSe","Tau_rawDeepTau2017v2p1VSe", binning=(20, 0, 1),
                    x_title=Label("rawDeepTauv2p1VSe")),
            Feature("DeepTauv2p1VSjet","Tau_rawDeepTau2017v2p1VSjet", binning=(20, 0, 1),
                    x_title=Label("rawDeepTauv2p1VSjet")),
            Feature("DeepTauv2p1VSmu","Tau_rawDeepTau2017v2p1VSmu", binning=(20, 0, 1),
                    x_title=Label("rawDeepTauv2p1VSmu")),

            Feature("DeepTauv2p5VSe","Tau_rawDeepTau2018v2p5VSe", binning=(20, 0, 1),
                    x_title=Label("rawDeepTauv2p5VSe")),
            Feature("DeepTauv2p5VSjet","Tau_rawDeepTau2018v2p5VSjet", binning=(20, 0, 1),
                    x_title=Label("rawDeepTauv2p5VSjet")),
            Feature("DeepTauv2p5VSmu","Tau_rawDeepTau2018v2p5VSmu", binning=(20, 0, 1),
                    x_title=Label("rawDeepTauv2p5VSmu")),
